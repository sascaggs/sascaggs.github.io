...
Ecological Anthropology $\times$ Cultural Anthropology $\times$ Evolutionary Anthropology $\times$ Complex Adaptive Systems $\times$ Network Science $\times$ Computational Social Science $\times$ Landscape Ecology $\times$ Community Ecology $\times$ Spatial Patterns $\times$ Hierarchical Bayesian Models
